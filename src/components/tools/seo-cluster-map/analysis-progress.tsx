  ...
  return (
    <Card className="mx-auto w-full max-w-2xl">
      <CardHeader>
        ...
        {url && (
          <p className="text-muted-foreground text-sm">Analyzing: {url}</p>
        )}
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="text-muted-foreground flex justify-between text-xs">
          <div
            className={`flex items-center gap-1 ${
              ["validating", "analyzing", "generating", "complete"].includes(
                currentStep,
              )
                ? "text-primary"
                : ""
        ...
        {isError && (
          <Alert
            variant={currentStep === "timeout" ? "default" : "destructive"}
          >
        ...
        {isComplete && (
          <Alert>
            ...
            <AlertDescription>
              Your SEO strategy has been generated successfully! Review the
        ...
        {timeElapsed > 45 && !isComplete && !isError && (
          <Alert>
            ...
            <AlertDescription>
              Analysis is taking longer than usual. This may timeout in{" "}
