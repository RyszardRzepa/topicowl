...
export async function GET(req: NextRequest) {
  try {
    ...
    const settingsResponse: ProjectSettingsResponse = {
      ...
      excludedDomains: Array.isArray(project.excludedDomains)
        ? project.excludedDomains
        : [],
      sitemapUrl: project.sitemapUrl,
      webhookUrl: project.webhookUrl,
      webhookSecret: project.webhookSecret,
      webhookEnabled: project.webhookEnabled,
      webhookEvents: Array.isArray(project.webhookEvents)
        ? (project.webhookEvents as string[])
        : [],
...
export async function PUT(req: NextRequest) {
  try {
    ...
    const settingsResponse: ProjectSettingsResponse = {
      ...
      keywords: Array.isArray(updatedProject.keywords)
        ? (updatedProject.keywords as string[])
        : [],
      toneOfVoice: updatedProject.toneOfVoice,
      articleStructure: updatedProject.articleStructure,
      maxWords: updatedProject.maxWords,
      excludedDomains: Array.isArray(updatedProject.excludedDomains)
        ? updatedProject.excludedDomains
        : [],
