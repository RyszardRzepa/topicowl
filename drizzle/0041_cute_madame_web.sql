...
CREATE TYPE "topicowl"."article_status" AS ENUM('idea', 'scheduled', 'queued', 'to_generate', 'generating', 'wait_for_publish', 'published', 'deleted');--> statement-breakpoint
...
--> statement-breakpoint
DROP TABLE "contentbot"."article_generation" CASCADE;--> statement-breakpoint
DROP TABLE "contentbot"."article_settings" CASCADE;--> statement-breakpoint
DROP TABLE "contentbot"."articles" CASCADE;--> statement-breakpoint
DROP TABLE "contentbot"."generation_queue" CASCADE;--> statement-breakpoint
DROP TABLE "contentbot"."projects" CASCADE;--> statement-breakpoint
DROP TABLE "contentbot"."user_credits" CASCADE;--> statement-breakpoint
DROP TABLE "contentbot"."users" CASCADE;--> statement-breakpoint
DROP TABLE "contentbot"."webhook_deliveries" CASCADE;--> statement-breakpoint
...
CREATE INDEX "webhook_deliveries_project_id_idx" ON "topicowl"."webhook_deliveries" USING btree ("project_id");--> statement-breakpoint
DROP TYPE "contentbot"."article_status";--> statement-breakpoint
DROP SCHEMA "contentbot";
